// UsageLoader.js — paste this ONCE into a Scriptable script named "Usage
// Widget" and assign it to a home-screen widget. It pulls the real
// UsageWidget code from GitHub each run, so pushing changes to the repo
// updates the widget with no re-pasting. Caches the last copy for offline use.

const WIDGET = "UsageWidget.js";
const RAW_BASE =
