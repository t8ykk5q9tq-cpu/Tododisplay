// ListLoader.js — paste this ONCE into a Scriptable script named "List Widget"
// and assign it to a home-screen widget. It pulls the real ListWidget code from
// GitHub each run, so pushing changes to the repo updates the widget with no
// re-pasting. Caches the last copy so it still renders if the network is down.

const WIDGET = "ListWidget.js";
const RAW_BASE =
